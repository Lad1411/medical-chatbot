...
class VectorDB:
    def __init__(self, db_path: str = "./chroma_db"):
        ...
        self.model = SentenceTransformer(
            "NeuML/pubmedbert-base-embeddings", device=self.device
        )
    ...
    def process_and_upsert_dataset(
        self, repo_id: str, max_samples: int = None, chunk_batch_size: int = 512
    ):
    ...
    def build_db(
        ...
        self.process_and_upsert_dataset(
            "MedRAG/textbooks",
            max_samples=textbooks_max_samples,
            chunk_batch_size=batch_size,
        )
        self.process_and_upsert_dataset(
            "MedRAG/pubmed", max_samples=pubmed_max_samples, chunk_batch_size=batch_size
        )
